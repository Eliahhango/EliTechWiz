...
async function syncdb() {
  ...
  let _0x5447f8 = EliTechWizConnect({
    logger: Pino({
...
Goodbye Msg: ${global.gdbye}`;
  ...
  _0x5447f8.messageId = (_0x344ea2 = 8, _0x4bb246 = "EliTechWiz") => {
